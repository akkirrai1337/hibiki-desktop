...
// The real content renders persistently from __root.tsx instead (see HomePersisted there) - this
// route's own component is a no-op. Leaving to another page and back used to fully unmount and
// remount this whole tree, silently resetting anything living in its component state (the hero's
// current slide, the continue-watching row's scroll position, the "you might like" pool's random
// offset re-rolling into a whole different set of titles on every single visit) - patching each of
// those individually one at a time was a losing game. Keeping the page mounted at all times and
// just hiding it when elsewhere sidesteps the whole category of bug at once.
